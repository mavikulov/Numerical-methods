...
class GUI:
    ...
    def plot_functions(self):
        ...
        tasks = [TestTask(int(self.entry_splits.get()), -1, 1, float(self.value_mu1.get()), float(self.value_mu2.get())),
                 FirstTask(int(self.entry_splits.get()), 0, np.pi, float(self.value_mu1.get()), float(self.value_mu2.get())),
                 SecondTask(int(self.entry_splits.get()), 0, np.pi, float(self.value_mu1.get()), float(self.value_mu2.get()))]
        option = self.var.get()
